...
const MEM_DIR =
  "C:\\Users\\jchildree\\.claude\\projects\\C--Users-jchildree-OneDrive---TheIndustrialLaboratoriesCompany-Desktop-Projects-nexus-apps-eqms\\memory";
...
fs.writeFileSync(outFile, outline, "utf8");
  ...
  `[memory-to-vault] Archived to: ${outFile} (${files.length} memory files)`
);
