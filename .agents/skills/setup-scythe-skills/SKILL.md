...
dependencies: []
cache_key: "setup-scythe-skills-2.0"
...
- `AGENTS.md` and/or `AGENTS.md` at the repo root -- does either exist? Is there already an `## Agent skills` section in either?
...
- If `AGENTS.md` exists, edit it, never erase content already present only update.
...
Never create `AGENTS.md` when `AGENTS.md` already exists (or vice versa) -- always edit the one that's already there, never erase content already present only update.
