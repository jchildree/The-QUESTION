...
2. `AGENTS.md` declares a `wiki-path:` field
...
Run `.Codex/skills/wiki/wiki-graph.sh <vault-path>` for a deterministic wikilink listing, then augment with the tree layout below.
